...
const SimulationCanvasNew = ({ simulation, readOnly, agentSelected, onAgentSelected }) => {
    ...
    useEffect(() => {
        console.log("Agent selected from the outside world")
    ...
    useEffect(() => {
        ...
        function addNode(position) {
            ...
            cy.add(node);
            console.log("simulation tweak", simulation)
        ...
        cy.on('add', 'node', function (event) {
            ...
            onAgentSelected(addedNode.data());
        });
        ...
        cy.on('tap', 'node', function (evt) {
            ...
            onAgentSelected(clickedNode.data());            
...
export default SimulationCanvasNew;
